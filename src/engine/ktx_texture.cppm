 ...
 * @param ktx_filepath The filepath to the KTX texture to load.
 * @param physical_device_features The physical device features for determining the best available transcode target.
 * @param log The log implementation for writing messages when loading a KTX texture.
 ...
 * @see [libktx Reference](https://github.khronos.org/KTX-Software/libktx/index.html)
 */
