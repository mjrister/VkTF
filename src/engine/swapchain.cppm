 ...
 * \details This abstraction handles determining the swapchain image count, format, and present mode based on physical
 *          device characteristics in addition to the lifetime management of a Vulkan swapchain.
 */
export class [[nodiscard]] Swapchain {
public:
  /** \brief Parameters used to create a \ref Swapchain. */
  ...
  /**
   * \brief Constructs a \ref Swapchain.
   * \param device The device to create the swapchain from.
