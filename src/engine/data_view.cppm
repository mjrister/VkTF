 ...
 * @warning The underlying data for this view must remain valid for the entire lifetime of this abstraction.
 */
...
public:
   ...
   * @param data The single element to create a view of.
   */
  constexpr DataView(const T& data) noexcept : data_{&data}, size_{1} {}  // NOLINT(*-explicit-*)

  /**
   * @brief Creates a @ref DataView.
   * @param data The pointer to data to create the view of.
