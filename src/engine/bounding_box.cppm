 ...
 * @details An axis-aligned bounding box represents the minimum extent needed to enclose a set of vertices for use in
 ...
 * @param transform The matrix transformation whose basis vectors represent the new coordinate space.
