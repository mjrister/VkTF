...
std::vector<std::uint32_t> GenerateSpirv(const glslang_stage_t glslang_stage,
                                         glslang_program_t* const glslang_program) {
...
std::vector<std::uint32_t> GlslangCompiler::Compile(const glslang_stage_t glslang_stage,
  ...
  return GenerateSpirv(glslang_stage, glslang_program.get());
}
