...
/** \brief Writes a glslang shader info log to an output stream. */
...
/** \brief Writes a glslang program info log to an output stream. */
...
/** \brief Generates SPIR-V bytecode from a glslang program. */
...
/** \brief Enables use of glslang shader stages with std::format. */
template <>
