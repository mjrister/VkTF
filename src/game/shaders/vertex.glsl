...
void main() {
  ...
  fragment.world_normal = mat3(model_transform) * normal; // model transform assumed to be an orthogonal matrix
  fragment.world_tangent = vec4(mat3(model_transform) * tangent.xyz, tangent.w);
