 ...
 *          keys to move through the scene. Press ESC to exist the application.
 * \note This file is primarily intended to demonstrate how to use core Engine APIs to load and render a scene composed
